...
let vowelsQuantity : VowelsQuantity = new VowelsQuantity();
...
let vowelsQuantityArvore : VowelsQuantity = new VowelsQuantity("Árvore", true);
vowelsQuantityArvore.showVowelsQuantity();

let vowelsQuantityCoracao : VowelsQuantity = new VowelsQuantity('Há um coração batendo <3', true);
